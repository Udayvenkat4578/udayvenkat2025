...
>
          ...
          <div className="flex flex-wrap gap-3 font-cyberpunk text-[14px] cursor-pointer">
            {[
              'HTML5', 'CSS', 'TailwindCSS', 'Express.js', 'JavaScript','Git','Responsive Design',  'User Experience Design','AWS',
              'React.js', 'Next.js', 'Node.js', 'Github', 'MongoDB','SQL', 'User Interface Design',
              'Figma', 'Micro Animations', 'UX Research', 'Prototyping', 'Firebase', 'Adobe XD'
            ].map((skill, index) => (
              <span
                key={index}
